...
Installation:
  ...
  2. Set the appropriate MongoDB connection string in .env file.
  3. Run 'npm start' to start the NodeJS server on Port 3000.
...
Author: Anand Doijode (ananddoijode8@gmail.com)
